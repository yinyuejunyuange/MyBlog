...
CREATE TABLE `user` (
  ...
  `update_time` datetime NOT NULL COMMENT '修改日期',
  `is_delete` int NOT NULL COMMENT '删除 1：删除 0：未删除',
  `is_freeze` int NOT NULL COMMENT '是否被封禁 ：1 冻结 2：正常 3：禁止',
...
INSERT INTO `user` VALUES (1,'oyyjs','$2a$10$UnYvhVqb.WqI9Yuh04lJLeqY0OWLP.jNfh9Sm/7QG4Ot.eA8jBmAy','4732c957-202.jpg',0,'2022-01-01 12:00:00','2022-01-01 12:00:00',0,2,'3129544205@qq.com','123123',1),(1893237050568912898,'zly','$2a$10$RRRGxgRBLYagN3XbEqqyOO9B5Lu42U6AvssIinT6Jm20D.ZUJJbC.','ee25a2d9-3下载 (1).png',0,'2025-02-22 09:51:02','2025-02-22 09:51:02',0,2,'3129544205@qq.com',NULL,0),(1897503922344714241,'suanli','$2a$10$4JupMrovMUByT2AQHsj7i.dHxqiI.EE7VS/9aK.MDbfBV.p7040U6','/man.jpg',1,'2025-03-06 04:26:04','2025-03-06 04:26:04',0,1,'3129544205@qq.com',NULL,0);
...
INSERT INTO `user_kudos` VALUES (1,1893581843467694082),(1,1896899273258549249),(1,1897230261939343361),(1,1901895485695025153),(1893237050568912898,1893581843467694082);
...
-- Dump completed on 2025-03-20 21:13:03
